...
<html>   
    ...
    <center>
        <table border="2">
            ...
            %>
            <form action="actualizarcita.jsp" method="post">
            ...
            <tr><th>EXAMENES REQUERIDOS: </th><td><input type="text" name="obs" value="<%out.print(rs1.getString("observacion"));%>"></td></tr>
                </td>
            <%
            }
            %>
   ...
   <%
    if(request.getParameter("grabar")!=null)
    {
      ...
      String t=request.getParameter("tra");
      String o=request.getParameter("obs");
      try
      {
       PreparedStatement ps=conexi.prepareStatement("UPDATE CITA_MEDICA SET cod_consulta='"+c+"',ci_medico='"+m+"',ci_paciente='"+p+"',fecha_consulta='"+f+"',hora_consulta='"+h+"',revision='"+r+"',diagnostico='"+d+"',tratamiento='"+t+"',observacion='"+o+"' WHERE cod_consulta='"+c+"'");
       ps.execute();
