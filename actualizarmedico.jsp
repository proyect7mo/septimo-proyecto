...
<html>
    ...
    <CENTER> <h1>ACTUALIZACION DATOS DEL MÉDICO</h1></center>     
    <center>
        <table border="2">
            <%
            ...
            %>
            <form action="actualizarmedico.jsp" method="post">
            <tr><th colspan="2">DATOS PERSONALES DEL MÉDICO</th></tr>
            <%
            while(rs1.next())
            {
            %>
            <tr><th>CEDULA DE IDENTIDAD</th><td><input type="text" name="ced" value="<%out.print(rs1.getString("ci_medico"));%>"></td></tr>
            ...
            %>
            <tr><td><input type="submit" name="grabar" value="ACTUALIZAR"</td>
   ...
   <%
    if(request.getParameter("grabar")!=null)
    {
      ...
      try
      {
       PreparedStatement ps=conexi.prepareStatement("UPDATE MEDICO SET nombres_m='"+n+"',apellidos_m='"+a+"',direccion_m='"+d+"',estadoc_m='"+e+"',telefono_m='"+t+"',especialidad='"+es+"' WHERE ci_medico='"+ci+"'");
       ps.execute();
