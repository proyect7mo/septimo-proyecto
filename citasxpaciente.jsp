...
<html>
    ...
    <body>
        ...
        <table border="1">
        <%
        String ci=(String)session.getAttribute("miv");
        PreparedStatement sp=conexi.prepareStatement("Select PACIENTE_HISTORIA.nombres_p,PACIENTE_HISTORIA.apellidos_p, CITA_MEDICA.* from CITA_MEDICA,PACIENTE_HISTORIA WHERE PACIENTE_HISTORIA.ci_paciente=CITA_MEDICA.ci_paciente and CITA_MEDICA.ci_paciente='"+ci+"'");
