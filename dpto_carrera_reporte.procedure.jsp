...
<html>
    ...
    <body>
        ...
        CallableStatement cStmt=conexi.prepareCall("(call reporte(?)");
           ...
           <% while (rs.next())
            {
             ...
             <tr>
              ...
              <td><a href="medico_eliminar.jsp?id=<% out.print(rs.getString("cod_dpto"));%>"><img src="eliminar.jpg" width="40" height="40"></a></td>
               <td><a href=medico_actualizar.jsp?id=<% out.print(rs.getString("cod_dpto"));%>"><img src="actualizar.jpg" width="40" height="40"></a></td>
               <% }%>
